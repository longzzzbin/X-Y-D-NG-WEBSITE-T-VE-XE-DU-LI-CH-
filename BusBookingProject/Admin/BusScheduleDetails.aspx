        ...
        <div class="col-lg-8 col-sm-8 col-md-2 col-sm-offset-2 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Thêm lịch trình xe</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <asp:Label ID="lblFirstName" runat="server" Text="Ngày xuất phát" Font-Bold="true"></asp:Label>
                            <asp:TextBox ID="txtDate" runat="server" placeholder="DD/MM/YYYY" class="form-control input-sm floatlabel"/>
                             <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDate" Display="None" ID="rfvFirstName" ValidationGroup="vgRegister"
                                    CssClass="text-danger" ErrorMessage="Không được bỏ trống ngày xuất phát" /><br />
                        </div>
                       <div class="form-group">
                            <asp:Label ID="lblUserName" runat="server" Text="Giá vé" Font-Bold="true"></asp:Label>
                            <asp:TextBox ID="txtFare" runat="server" class="form-control input-sm floatlabel" />
                             <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFare" Display="None" ID="rfVMobileNo" ValidationGroup="vgRegister"
                                    CssClass="text-danger" ErrorMessage="Không được bỏ trống giá vé" /><br />
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        
                        <div class="form-group">
                            <asp:Label ID="lblEmail" runat="server" Text="Giờ đi" Font-Bold="true"></asp:Label>
                            <asp:TextBox ID="txtDeparture" placeholder="00:00 AM/PM Format"  runat="server" class="form-control input-sm floatlabel" />
                             <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDeparture" Display="None" ID="rfVEmail" ValidationGroup="vgRegister"
                                    CssClass="text-danger" ErrorMessage="Không được bỏ trống giờ đi" /><br />
                        </div>
                        <div class="form-group">
                            <asp:Label ID="lblPassword" runat="server" Text="Giờ đến" Font-Bold="true"></asp:Label>
                            <asp:TextBox ID="txtArrival" runat="server" placeholder="00:00 AM/PM Format" class="form-control input-sm floatlabel"  />
                             <asp:RequiredFieldValidator runat="server" ControlToValidate="txtArrival" Display="None" ID="rfvPassword" ValidationGroup="vgRegister"
                                    CssClass="text-danger" ErrorMessage="Không được bỏ trống giờ đến" /><br />
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">                        
                        <div class="form-group">
                            <asp:Label ID="lblLastName" runat="server" Text="Tổng thời gian" Font-Bold="true"></asp:Label>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtTravelTime" Display="None" ID="rfVLastName" ValidationGroup="vgRegister"
                                    CssClass="text-danger" ErrorMessage="Không được bỏ trống tổng thời gian" /><br />
                        </div>
                    </div>
                    <asp:Button ID="btnSaveSchedule" runat="server" Text="Lưu lịch trình" style="margin-top:20px; width: 20%"  OnClick="btnSaveSchedule_Click" class="btn btn-success " ValidationGroup="vgRegister"  CausesValidation="True" ViewStateMode="Inherit" />
                </div>
            </div>
        </div>
    </div>
