    ...
    public partial class BusDetails : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (btnSave.Text == "Insert")
            {
                ...
                if (result == -1)
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Thêm thông tin xe thành công.')", true);
                    txtDetination.Text = "";
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Thêm thông tin xe thất bại')", true);
                }
            }
            else
            {
                ...
                if (result == -1)
                {
                    ...
                    //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Cập nhật thông tin xe thành công.')", true);
                }
                else
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Cập nhật thông tin xe thất bại.')", true);
                }
            }
