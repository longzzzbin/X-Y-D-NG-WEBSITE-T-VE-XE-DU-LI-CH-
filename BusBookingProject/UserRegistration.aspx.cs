...
namespace BusBookingProject
{
    public partial class UserRegistration : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Đăng kí tài khoản thành công.')", true); 
            }
            else if(RegistrationStatuis==-1)
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Số điện thoại đã tồn tại. Vui lòng thử lại với số khác.')", true); 
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Đăng kí tài khoản không thành công.')", true); 
            }
            txtFirstName.Text = "";
            txtLastName.Text = "";
            txtAddress.Text = "";
